				...
				<div class="flex flex-col md:flex-row items-center justify-between gap-8">
					<div class="text-center md:text-left">
						...
						<p class="text-xl text-gray-400 max-w-2xl">
							일일 도전과제 달성률과 PP 성장을 한눈에 확인하세요. 매일매일의 작은 성장이 큰 발전으로
							이어집니다.
						</p>
					</div>
				...
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
					{#each DIFFICULTIES as difficulty}
						<StatsCard
							...
							percentage={(stats.byDifficulty[difficulty].completed /
                            ...
                            {challenge.difficulty === 'EASY'
												...
												<div class="flex items-center">
													{#if challenge.completed}
														<div
															class="flex items-center text-sm text-green-400 bg-green-500/10 px-3 py-1.5 rounded-lg"
														>
													...
													{:else}
														<span
															class="text-sm text-gray-500 bg-gray-500/10 px-3 py-1.5 rounded-lg"
														>
	...
	{:else}
		<div class="min-h-screen flex items-center justify-center">
			<div class="text-center p-8">
				<div
					class="w-24 h-24 bg-dark-100 rounded-full flex items-center justify-center mx-auto mb-6"
				>
