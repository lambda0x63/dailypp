...
<div class="min-h-screen bg-dark-300">
	...
	<div class="absolute inset-0 overflow-hidden opacity-10">
		<div
			class="absolute w-[500px] h-[500px] bg-osu-pink rounded-full blur-[160px] animate-float top-0 -left-64"
		></div>
		<div
			class="absolute w-[500px] h-[500px] bg-osu-purple rounded-full blur-[160px] animate-float-delayed -bottom-64 right-0"
		></div>
	</div>
			...
			<div class="max-w-7xl mx-auto px-4">
				<div class="text-center max-w-3xl mx-auto">
					...
					<p class="text-xl text-gray-400 mb-12">
						매일 새로운 비트맵으로 자신의 실력을 시험해보세요. 당신의 PP에 맞춤화된 도전과제가
						기다리고 있습니다.
					</p>
					...
					<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
						{#each features as feature}
							...
							>
								<div
									class="w-12 h-12 rounded-xl bg-osu-pink/20 flex items-center justify-center mx-auto mb-4"
								>
			...
			<div class="relative max-w-7xl mx-auto px-4 py-12">
				...
				<div class="flex items-center justify-between mb-8">
					<div class="flex gap-2">
						<div
							class="px-4 py-1.5 rounded-full text-sm font-medium bg-green-500/20 text-green-400"
						>
							Easy
						</div>
						<div
							class="px-4 py-1.5 rounded-full text-sm font-medium bg-yellow-500/20 text-yellow-400"
						>
							Normal
						</div>
					...
					<div class="text-sm text-gray-400">매일 00:00 KST에 갱신</div>
				</div>
				...
				<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{#each demoChallenges as challenge, i}
						...
						>
							<div
								class="bg-dark-100/95 backdrop-blur-md rounded-xl border border-gray-800/50 shadow-lg"
							>
								<ChallengeCard {challenge} onComplete={handleComplete} completing={null} {isDemo} />
							</div>
						</div>
					{/each}
				</div>
