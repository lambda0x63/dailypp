...
<div
	class="bg-dark-100/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-300"
>
	<div class="flex items-center justify-between mb-4">
		<div class="flex items-center gap-3">
			<div
				class="w-10 h-10 rounded-xl {color.replace(
					'500',
					'500/20'
	...
	<div class="space-y-2">
		...
		<div class="h-2 bg-dark-200 rounded-full overflow-hidden">
			...
			<div class="h-full transition-all duration-500 {color}" style="width: {percentage}%" />
		</div>
	</div>
</div>
