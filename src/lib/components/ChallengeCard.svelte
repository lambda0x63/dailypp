...
<div class="relative bg-dark-300 rounded-2xl overflow-hidden">
	...
	<div class="relative h-48">
		...
		<div class="absolute top-4 right-4 z-20">
			<div
				class="px-4 py-1 rounded-full text-sm font-bold shadow-lg backdrop-blur-sm
	...
	<div class="relative p-6 space-y-6">
		...
		<div class="space-y-3">
			...
			<div class="flex items-center justify-between gap-3">
				...
				{#if challenge.completed}
					<div
						class="flex items-center space-x-2 bg-green-500/20 text-green-400 px-3 py-1.5 rounded-lg text-sm flex-grow justify-center"
					>
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path
								stroke-linecap="round"
		...
		{#if challenge.completed && challenge.score}
			<div class="mt-6 pt-6 border-t border-gray-800/50">
                ...
                ${
									challenge.score.rank === 'S' || challenge.score.rank === 'SH'
										? 'text-yellow-400'
										: challenge.score.rank === 'A'
											? 'text-green-400'
											: challenge.score.rank === 'B'
												? 'text-blue-400'
												: challenge.score.rank === 'C'
													? 'text-purple-400'
													: challenge.score.rank === 'D'
														? 'text-red-400'
														: 'text-white'
								}`}
							>
